...
function handleTOpenPopover() {
  // popoverAvailable.value = true
            ...
            <div :class="$style.homeTextAreaRightBox">
              ...
              >
                <div :class="$style.homePopoverHeader">
                  ...
                  <Icon :class="$style.homeIcon" icon="material-symbols:close-rounded" color="#A9A9A9" @click="status = 'initial'" />
                </div>
                <div :class="$style.homePopoverContent">
                  <div :class="$style.homePopoverContentHeader">
                    ...
                    <div :class="$style.homePopoverContentRefresh">
                      ...
                      <span>1/1</span>
                      <Icon :class="$style.homePopoverIcon" icon="material-symbols:chevron-right-rounded" color="#DADCE0" />
                    </div>
                  </div>
                  <div :class="$style.homePopoverContentArea">
                ...
                <div :class="$style.homePopoverBtnGroup">
                  <button :class="$style.homePopoverCopyGroup">
                    Copy
                  </button>
              ...
              <div
                ref="area" :class="$style.homeTextAreaTag" contenteditable placeholder="To rewrite text, enter or paste it here and press &quot;Paraphrase.&quot;"
                @blur="handleMouseBlur"
